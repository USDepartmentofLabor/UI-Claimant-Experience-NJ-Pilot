...
describe('DevHome', () => {
  it('renders without error', () => {
    ...
    expect(screen.getByText('preface2_bold'))
    expect(screen.getByText('preface2_continued'))
    expect(screen.getByText('preface2_link'))
    expect(screen.getByText('preface3'))
    expect(screen.getByText('preface3_bold'))
    expect(screen.getByText('preface3_continued'))*/
