...
## :warning: Disclaimer
The code in this repository represents the development efforts towards building a state-specific claimant intake form. 
This public repository exists purely for the purposes of hosting a snapshot of code to serve as a reference for similar efforts, and is therefore not actively maintained.
Readers of this message are looking at outdated, incomplete, and un-runnable code, without specific credentials.
It is recommended to use this as a resource or reference rather than attempting to expand on or assimilate large sections of code.  
Entities wishing to use this code will need to remove unusable integrations locked behind state secured infrastructure, and should do standard due diligence and make sure to use up-to-date dependencies.

![Test and Lint](https://github.com/USDepartmentofLabor/UI-Claimant-Experience-NJ-Pilot/actions/workflows/build-and-test.yml/badge.svg)
![Deploy Dev](https://github.com/USDepartmentofLabor/UI-Claimant-Experience-NJ-Pilot/actions/workflows/deploy-dev.yml/badge.svg)
![Image Scans](https://github.com/USDepartmentofLabor/UI-Claimant-Experience-NJ-Pilot/actions/workflows/image-scans.yml/badge.svg)
